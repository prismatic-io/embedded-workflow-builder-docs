...
| Job References         | An array of external references to jobs assigned to this employee. See [Toast API documentation](https://doc.toasttab.com/openapi/labor/tag/Data-definitions/schema/Employee/) for more information.                                                                                        |         |
| Wage Overrides         | An optional array of per job wage overrides, where each element defines a job reference and the wage override for this employee when performing that job. See [Toast API documentation](https://doc.toasttab.com/openapi/labor/tag/Data-definitions/schema/Employee/) for more information. |         |
| Additional Fields      | Additional fields that might not be covered by the standard inputs. This is a JSON object. See [Toast API documentation](https://doc.toasttab.com/openapi/labor/tag/Data-definitions/schema/Employee/) for more information.                                                                |         |
...
| Employee Reference     | A wrapper object with fields that allow reference to a Toast platform entity by Toast GUID. See [Toast API documentation](https://doc.toasttab.com/openapi/labor/tag/Data-definitions/schema/Shift/) for more information. |         |
| External ID            | External identifier string that is prefixed by the naming authority.                                                                                                                                                       |         |
| Job Reference          | A wrapper object with fields that allow reference to a Toast platform entity by Toast GUID. See [Toast API documentation](https://doc.toasttab.com/openapi/labor/tag/Data-definitions/schema/Shift/) for more information. |         |
| Additional Fields      | Additional fields that might not be covered by the standard inputs. This is a JSON object. See [Toast API documentation](https://doc.toasttab.com/openapi/labor/tag/Data-definitions/schema/Shift/) for more information.  |         |
...
| Pagination    | Page size and page token controls for paginated results.                                                                                                                                                                                    |         |
...
| Connection             |                                                                                                                                                                                                                                                                                                                                                       |         |
| Restaurant External ID | The GUID of the restaurant that is the context of the request. Use the List Accessible Restaurants action to get the external ID of a restaurant.                                                                                                                                                                                                     |         |
| Date Range             | Start and end date and time of the time period to match shifts.                                                                                                                                                                                                                                                                                       |         |
...
| Date Range             | Start and end date and time of the time period to match time entries.                                                                                                                                                                                                                                                             |         |
...
| Include Missed Breaks  | Indicate whether missed breaks should be returned in the breaks array for the time entries.                                                                                                                                                                                                                                       | false   |
| Modified Date Range    | Start and end date and time of the time period to match modified time entries.                                                                                                                                                                                                                                                    |         |
...
| Restaurant External ID | The GUID of the restaurant that is the context of the request. Use the List Accessible Restaurants action to get the external ID of a restaurant.                                                                            |         |
| Employee ID            | The GUID of the employee to delete.                                                                                                                                                                                          |         |
| Name                   | First name, last name, and chosen name of the employee.                                                                                                                                                                      |         |
| First Name             | First name of the employee.                                                                                                                                                                                                  |         |
| Last Name              | Last name of the employee.                                                                                                                                                                                                   |         |
| Chosen Name            | Optional, chosen name of the employee. To be used, when appropriate, in place of first name.                                                                                                                                 |         |
| External Employee ID   | Optional, employee's external ID in the Toast platform.                                                                                                                                                                      |         |
